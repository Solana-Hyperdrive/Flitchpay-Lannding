  ...
  return (
    <div style={{ height: "100vh", width: "100%", background: "radial-gradient(70.32% 109% at 98.17% 55.75%, #401694 11.37%, #000 100%)" }} className="relative overflow-hidden">
      <div className="border-solid border-gray-500 rounded-xl border-2 p-3 ml-[1.75rem] mt-[1.44rem] w-[90%] h-[95%] xl:w-[95%] xl:h-[95%] xl:m-6 ">
        <div className="w-[42.15545rem] xl:ml-[3rem] xl:mt-[2rem]">
        ...
        <div className="h-full w-full flex lg:grid-cols-8">
          <div className="absolute left-[-11rem] top-[30rem] xl:left-[2rem] xl:top-[50%]">
            <img className="w-[23.8rem] xl:w-[60vw] aspect-auto block shrink-0" src="https://cdn.discordapp.com/attachments/1159478783020113980/1163837366197309553/Group_39574.webp?ex=65410703&is=652e9203&hm=7e86ef8ee152c073efdae7084634b97025df8b7aab215120aa3162d566a27a68&" alt="" />
          </div>
          <div className="absolute right-[-12rem] top-[26rem] xl:top-[20%] xl:right-[-18rem]">
            <img className="w-[25.5rem] aspect-auto xl:w-[60vw]" src="https://cdn.discordapp.com/attachments/1159478783020113980/1163837366608330803/Group_39575.webp?ex=65410703&is=652e9203&hm=c8dcc2707379ae2c3f3756426645cdd34bcf7880825d51731531bc9e33a7cc18&" alt="" />
          </div>
        </div>
